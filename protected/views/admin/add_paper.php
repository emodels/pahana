<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#li_add').addClass('current');
    });
</script>
<section id="content">
    <div class="wrapper-after" style="padding: 10px; position: relative">
        <h1 style="font-size: 22px; padding: 10px 0 10px 0">Add Newspaper</h1>
        <div class="form">
            <?php
            ...
            <div class="row" style="padding-top: 10px">
                ...
                <div class="column"><input type="submit" value="Add Newspaper" class="button" style="padding: 10px; font-size: 20px; cursor: pointer"/></div>
                <div class="clearfix"></div>
            </div>
            <?php $this->endWidget(); ?>
        </div>
