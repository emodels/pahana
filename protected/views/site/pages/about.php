...
<section id="content">
    <div class="wrapper-after" style="padding: 10px; position: relative;">
        <h1 style="font-size: 22px; padding: 10px 0 15px 0">About Pahana</h1>
        <div class="row">
            <div style="width: 570px; position: absolute; z-index: 9999">
            ...
            <p style="text-align: justify; padding-top: 180px"><strong>Circulation of the magazine:</strong></p>
            <ul style="list-style: disc; padding-left: 15px">
                <li style="padding-bottom: 15px">15,000 copies of Pahana Magazine will be distributed nation-wide.</li>
                <li style="padding-bottom: 15px">Approximately 50,000 readers.</li>
            </ul>
        </div>
        <div style="position: absolute; top: 25px; right: 10px; z-index: 1000"><img src="images/about_page_banner.jpg" /></div>
    </div>
</section>    