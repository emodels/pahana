...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#li_Objective').addClass('current');
    });
</script>
<section id="content">
    <div class="wrapper-after" style="padding: 10px; position: relative">
        <h1 style="font-size: 22px; padding: 10px 0 15px 0">Objective of the Pahana magazine</h1>
        <div style="width: 100%">
            ...
            <ul style="list-style: disc; padding-left: 15px; text-align: justify">
                ...
                <li style="padding-bottom: 15px">To provide useful information, guidance and assistance for the Sri Lankan community in their genuine efforts to assimilate into the Mainstream Society.</li>
            </ul>
        </div>
        <div style="position: absolute; right: 0px; top: 30px"><img src="images/tradition.jpg"/></div>
    </div>
</section>    